...
13. Компьютеры с общей и распредёленной памятью. Две задачи параллельных вычислений. (#13-компьютеры-с-общей-и-распредёленной-памятью-две-задачи-параллельных-вычислений具有共享内存和分布式内存的计算机并行计算的两个任务)
