...
5 Архитектура и параметры суперкомпьютеров-лидеров Top500  
--------------------------------------------------  
...
6 Этапы решения задач на параллельных вычислительных системах. Пиковая и реальная производительность компьютеров. Понятие 
--------------------------------------------------
一、解题六步法：从公式到可执行代码  
